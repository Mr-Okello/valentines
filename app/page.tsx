...
const reasons = [
  [
    ...
    "Not stressed.",
    "Not confused.",
    "Just okay being myself.",
  ],
  [
    "You laugh freely.",
    "Like you’re not pretending.",
    "It’s real.",
    "And it pulls me in every time.",
  ],
  [
  ...
  [
    ...
    "Your energy pulls my attention.",
    "I lose focus around you.",
  ...
  return (
    <main className="min-h-screen w-full bg-rose-100 text-rose-900">
      {stage === "welcome" && (
        <section className="mx-auto flex min-h-screen max-w-4xl items-center justify-center p-6">
          <div className={cardClasses}>
            <h1 className="text-3xl font-bold sm:text-4xl">Hey Karyn Amiya Peter (mwiza) 💖</h1>
            <p className="mt-4 text-lg text-rose-700">Play the game to unlock why I love you.</p>
            <button
              onClick={() => {
                setScore(0);
                setStage("game");
        ...
        <section className="mx-auto flex min-h-screen max-w-4xl items-center justify-center p-6">
          <div className="w-full text-center">
            ...
            <div key={reasonIndex} className={`${cardClasses} reason-in mx-auto text-left`}>
              <p className="text-xl font-semibold text-rose-800">{reasonIndex + 1}. I love you because…</p>
      ...
      {stage === "question" && (
        <section className="mx-auto flex min-h-screen max-w-4xl items-center justify-center p-6">
          <div className={cardClasses}>
            <h2 className="text-4xl font-bold leading-tight">Karyn… will you be my Valentine? 💘</h2>
